...
from jishaku.paginators import WrappedPaginator as CommandPaginator
    ...
    async def paginate(self):
        ...
        while self.paginating:
            ...
            try:
                    ...
                    self.bot.wait_for('reaction_add', check=self.react_check),
                    self.bot.wait_for("reaction_remove", check=self.react_check)
                    ],
                timeout=60,
